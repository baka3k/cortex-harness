...
**Trạng thái:** draft (rev 2) — **11/14 native 2026-09-15** (reports/phase-05.md);
`start` + `stop` port ở `phase-05b-lifecycle-start-stop.md`; còn shim: `doctor`, `infra-up`, `infra-down`.
