...
relatedPlans:
  ...
  - "260915-2300-sync-plane-rust-cutover"  # wave sync-plane CUỐI — CLOSED 2026-09-16 (waiver dogfood): wire + flip + xoá incremental_sync.py; tag `pre-syncplane-delete`; các gate của plan này (dogfood stock §2) đã waived bởi user cho lane này
