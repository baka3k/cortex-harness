...
- chạy: 2026-09-14 06:27:05
- testdata: `tests/fixtures/sql-family/sql` (create procedure/function regex scan, call/exec/generic-call/bare-call extraction, builtins pg_catalog/dbms_, unresolved callees)
...
- py: `[SCAN_RESULT] parser=sql files=3 functions=4 classes=0`
- rust: `[SCAN_RESULT] parser=sql files=3 functions=4 classes=0`
...
- py: `[SCAN_RESULT] parser=sql files=2 functions=4 classes=0`
- rust: `[SCAN_RESULT] parser=sql files=2 functions=4 classes=0`

- cleanup: py=(8, 0) rust=(8, 0)
