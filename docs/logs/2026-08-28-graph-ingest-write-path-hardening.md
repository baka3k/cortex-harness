...
The real 24-file `procsample` canary recovered an interrupted run, then completed a clean final-contract run with the durable producer sentinel: 56/56 batches ACKed, exact audit digest/cardinality validated before the first edge lease, and exact local/remote parity at 646 business nodes, 1,327 relationships, and 24 files (`plans/260807-1202-graph-ingest-write-path-hardening/reports/final-validation-2026-08-28.md:21-55`). A deterministic generated 20,186-file fixture completed the file-backed required-mode scale gate in 49.31 seconds with 122/122 batches ACKed and 60,559 rows conserved (`scripts/generate_graph_ingest_scale_fixture.py:12-15`, `scripts/generate_graph_ingest_scale_fixture.py:35-116`, `plans/260807-1202-graph-ingest-write-path-hardening/reports/final-validation-2026-08-28.md:64-87`). The final regression passed 1,458 tests and 270 subtests with 10 skips and no failures (`plans/260807-1202-graph-ingest-write-path-hardening/reports/final-validation-2026-08-28.md:89-107`).
