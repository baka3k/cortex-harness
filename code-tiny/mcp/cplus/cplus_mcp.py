...
def _qdrant_search(
    ...
    Migrated from the legacy ``/points/search`` endpoint because that
...
async def tool_listup_symbols_matching_file_path(
    ...
    if node_types_filter:
        ...
        type_conditions = "n:Function OR n:Type OR n:Namespace OR n:File OR n:Field OR n:Alias OR n:Template OR n:FunctionType OR n:Event OR n:Project"
