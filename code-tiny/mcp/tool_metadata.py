...
_FULL_CATALOG: List[Dict[str, Any]] = [
    ...
    {
        "name": "list_parsers",
        "description": "List canonical parser capability profiles and their aliases, backends, support levels, and features.",
        "use_cases": ["Check supported languages", "Discover parser options", "Inspect support boundaries"],
        "inputs": [],
        "output": "Dict with parsers aliases plus canonical capabilities, active capability, and default backend",
