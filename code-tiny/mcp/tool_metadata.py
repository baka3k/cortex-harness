...
_FULL_CATALOG: List[Dict[str, Any]] = [
    ...
    # --- C++ / generic trace_flow ------------------------------------------------
    {
        ...
        "inputs": [
            ...
            {"name": "end_id", "type": "str", "required": False,
             "description": "Optional end node. When omitted the trace runs in the requested direction from start_id."},
    ...
    },
    {
        ...
        "inputs": [
            {"name": "project_id", "type": "str", "required": False,
             "description": "Case-insensitive project scope. All nodes in the returned paths share this logical project_id. Omit to search every registered project."},
    ...
    },
    {
        ...
        "inputs": [
            {"name": "project_id", "type": "str", "required": False, "description": "Project identifier — selects the graph shard via the project registry. Omit to search every registered project."},
            ...
            {"name": "limit", "type": "int", "required": False},
            {"name": "parser_type", "type": "str", "required": False, "description": "Optional parser capability profile. Omit to resolve from the project profile or active default."},
        ],
