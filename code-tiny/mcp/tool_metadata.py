...
_FULL_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "inputs": [
            ...
            {"name": "db", "type": "str", "required": False,
             "description": "Graph database or graph name (uses active/default context)"},
        ],
        "output": (
    ...
    # --- Semantic / vector -------------------------------------------------------
    {
        ...
        "inputs": [
            ...
            {"name": "db", "type": "str", "required": False,
             "description": "Graph database or graph name"},
            ...
            {"name": "parser_type", "type": "str", "required": False,
             "description": "Parser capability profile used for labels, properties, and graph relationships"},
        ],
        "output": (
    ...
    },
    {
        ...
        "inputs": [
            ...
            {"name": "db", "type": "str", "required": False,
             "description": "Graph database or graph name"},
            {"name": "parser_type", "type": "str", "required": False,
             "description": "Parser capability profile for relationship validation"},
        ],
    ...
    },
    {
        ...
        "inputs": [
            ...
            {"name": "db", "type": "str", "required": False,
             "description": "Graph database or graph name"},
            {"name": "parser_type", "type": "str", "required": False,
             "description": "Parser capability profile for endpoint-chain traversal defaults"},
        ],
    ...
    },
    {
        ...
        "inputs": [
            ...
            {"name": "parser_type", "type": "str", "required": False,
             "description": "Parser capability profile for impact traversal defaults"},
        ],
    ...
    },
    {
        ...
        "inputs": [
            ...
            {"name": "parser_type", "type": "str", "required": False,
             "description": "Parser capability profile for workflow traversal defaults"},
        ],
    ...
    },
    {
        ...
        "example": "get_project_modules(project_id='shop', limit=50)",
    },
    {
        ...
        "example": "get_public_apis(project_id='shop', language='kotlin')",
    },
    {
        "name": "get_endpoints",
        ...
        "example": "get_endpoints(project_id='shop', protocol='grpc')",
    },
    {
        ...
        "example": "get_module_architecture_summary(project_id='shop', module_id='project-module:shop:app')",
    },
    {
        ...
        "example": "get_project_special_files(project_id='shop', role='topology')",
    },
    {
        ...
        "example": "get_framework_context(project_id='shop', framework='spring')",
    },
]
