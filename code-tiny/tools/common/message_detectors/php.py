...
class PhpMessageDetector(BaseMessageDetector):
    ...
    def extract_sender(self, line_text: str) -> Optional[str]:
        match = _PHP_FN_PATTERN.match(line_text.strip())
    ...
    def extract_fields(self, callee_name: str, args: Sequence[str]):
        ...
        explanation = f"{callee_name}() inferred by php detector"
