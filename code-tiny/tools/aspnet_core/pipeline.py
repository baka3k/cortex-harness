...
from tools.aspnet_core.artifact_parsers import parse_appsettings, parse_razor
from tools.aspnet_core.detector import AspNetCoreDetector
from tools.aspnet_core.resolver import resolve_roslyn_evidence
...
def run_aspnet_core_analysis(
    *,
    ...
    detector = AspNetCoreDetector(root_abs)
    ...
    for detection in detections:
        ...
        try:
            ...
            for item in roslyn.get("diagnostics") or ():
                diagnostics.append(Diagnostic(
                    str(item.get("code") or "aspnet_core.roslyn"),
        ...
        for deleted in deleted_paths:
            if _in_module(deleted, detection.module_path):
                diagnostics.append(Diagnostic(
                    "aspnet_core.deleted_artifact", "Deleted artifact is included in module invalidation",
