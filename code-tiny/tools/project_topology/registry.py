...
PRIMARY_SPECIAL_FILE_COVERAGE: Mapping[str, CoverageEntry] = MappingProxyType(
    {
        ...
        "ini": CoverageEntry("ini", ("*.ini",), (DescriptorRole.CONFIGURATION,), ParseDepth.IDENTITY, "parser-special-files/ini"),
        "dat": CoverageEntry("dat", ("*.DAT", "*.dat"), (DescriptorRole.RESOURCE,), ParseDepth.IDENTITY, "parser-special-files/dat"),
        ...
        "shell": CoverageEntry("shell", ("*.sh",), (DescriptorRole.INTERFACE, DescriptorRole.DEPLOYMENT), ParseDepth.SEMANTIC, "parser-special-files/shell"),
        ...
        "jp1": CoverageEntry("jp1", ("*.txt",), (DescriptorRole.TOPOLOGY, DescriptorRole.DEPLOYMENT), ParseDepth.SEMANTIC, "parser-special-files/jp1"),
