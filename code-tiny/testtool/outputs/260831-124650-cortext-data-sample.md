...
- Overall: **PASS**
- Started: `2026-08-31T12:46:49.766695+07:00`
- Finished: `2026-08-31T12:46:50.091385+07:00`
- Duration: `0.32s`
- Project: `cortext`
- Parser: `python`
- Live inventory: `44` tools across `2` servers
- Cases executed: `10` (`10` passed, `0` failed)
...
| ---: | --- | --- | --- | --- | --- | --- | ---: |
| 1 | `graph_mcp` | `search_functions` | PASS | SUCCESS_DATA |  | PASS | 155.20 |
| 2 | `graph_mcp` | `list_databases` | PASS | SUCCESS_DATA |  | PASS | 4.40 |
| 3 | `graph_mcp` | `list_parsers` | PASS | SUCCESS_DATA |  | PASS | 4.64 |
| 4 | `graph_mcp` | `get_project_modules` | PASS | SUCCESS_DATA |  | PASS | 9.85 |
| 5 | `graph_mcp` | `get_symbol` | PASS | SUCCESS_DATA |  | PASS | 4.38 |
| 6 | `graph_mcp` | `list_mcp_functions` | PASS | SUCCESS_DATA |  | PASS | 4.84 |
| 7 | `graph_mcp` | `semantic_search` | PASS | SUCCESS_DATA |  | PASS | 48.63 |
| 8 | `graph_mcp` | `explore_graph` | PASS | SUCCESS_DATA |  | PASS | 22.55 |
| 9 | `mind_mcp` | `list_source_ids` | PASS | SUCCESS_EMPTY |  | PASS | 4.43 |
| 10 | `mind_mcp` | `list_qdrant_collections` | PASS | SUCCESS_EMPTY |  | PASS | 4.31 |
        ...
        "results": [
          {
            ...
            "properties": {
              ...
              "language": "python",
              "repo": "/Users/user/AI/cortex-harness",
              "build_system": "",
