...
```bash
export GLINER_MODEL_PATH=/Users/yourusername/tool/ai/gliner_medium-v2.1
```
...
```bash
export EMBEDDING_MODEL_PATH=/Users/yourusername/tool/ai/all-MiniLM-L6-v2
```
...
EMBEDDING_MODEL_PATH=/Users/yourusername/tool/ai/all-MiniLM-L6-v2
GLINER_MODEL_NAME=urchade/gliner_mediumv2
GLINER_MODEL_PATH=/Users/yourusername/tool/ai/gliner_medium-v2.1
