...
from tools.common.local_qdrant import RemoteQdrantUnsupportedError  # noqa: E402
...
class CobolQdrantContractTest(unittest.TestCase):
    ...
    def test_qdrant_target_rejects_path_injection_and_embedded_credentials(self):
        with self.assertRaises(RemoteQdrantUnsupportedError):
        ...
        with self.assertRaises(ValueError):
            _validate_target("/tmp/cortex-qdrant", "../collection")
